...
Schema.prototype.max = function (maxItems) {
  return this.extend({maxItems: maxItems})
}
...
Schema.prototype.min = function (minItems) {
  return this.extend({minItems: minItems})
}
...
Schema.prototype.unique = function (uniqueItems) {
  return this.extend({uniqueItems: uniqueItems})
}
